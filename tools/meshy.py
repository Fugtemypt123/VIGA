...
tool_configs = [
    {
        ...
        "function": {
            ...
            "description": "From the given inputs, imagine and articulate the scene in detail. This tool does not return new information. It stores your detailed description as your own plan to guide subsequent actions. You must call this tool first when generating a new scene.",
            "parameters": {
                "type": "object",
                "properties": {
                    ...
                    "download_object_list": {"type": "string", "description": "A list of fine-grained objects in the scene that need to be downloaded using the external tool in the later rounds. These objects often have complex textures or aggregate structures that cannot be formed by stacking basic geometry. Example: Oak desk, black office chair, mouse, ceramic mug, potted plant, carpet."}
                },
                "required": ["overall_description", "object_list", "object_relations", "initial_layout", "download_object_list"]
            }
        }
    },
    {
